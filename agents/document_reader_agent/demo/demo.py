...
def do_parse(
    ...
    f_draw_span_bbox_orig=False, # Whether to draw span bounding boxes on original pdf
    ...
    if backend == "pipeline":
        ...
        logger.error(f"Backend {backend} is not supported in this pipeline-only version.")
