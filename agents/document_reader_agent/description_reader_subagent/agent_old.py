        ...
        for line in lines:
            ...
            if match:
                ...
                if num > 0 and num % 5 == 0:
                    ...
                    # match.group(0) is the whole match (whitespace + number + whitespace)
                    # We want to keep the leading whitespace matching the original indentation if any?
                    # The user said "delete ... number ... at the start".
                    # Usually these are strictly at the start.
                    line = line[match.end():]
